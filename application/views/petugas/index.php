                                ...
                                <table class="table table-striped" id="dataTable">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $ptgs->username; ?></td>
                                                <td>
                                                    <a href="<?= base_url('petugas/ubah/' . $ptgs->id_petugas); ?>" class="btn btn-info">Ubah</a>
                                                    <a href="<?= base_url('petugas/hapus/' . $ptgs->id_petugas); ?>" class="btn btn-danger">Hapus</a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                        </table>
                                        <a href="<?= base_url('petugas/tambah'); ?>" class="btn btn-primary">Tambah</a>
                                </div> 
                                </div>
                        </div>
                    </div>
