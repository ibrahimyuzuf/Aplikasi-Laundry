                        ...
                        <div class="row">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Ubah Produk Laundry</h6>
                                </div>
                                <div class="card-body">
                                    <?php foreach($cari as $data) : ?>
                                    <form action="<?= base_url('produk/subah'); ?>" method="POST">
                                    <input type="hidden" name="kode" value="<?= $data->id_produk; ?>">
                                        <div class="mb-3">
                                            <label class="form-label">Nama Produk</label>
                                            <input type="text" name="nama" class="form-control" value="<?= $data->nama_produk; ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Harga Produk(/KG)</label>
                                            <input type="text" name="harga" class="form-control" value="<?= $data->harga_produk; ?>">
                                        </div>
